...
public class UniversityUrlBuilder {
	// Las prefecturas están en orden numerico con respecto a la web del crawler
		// para armar la URL.
		private final String[] prefecturesList = { "Hokkaido", "Aomori", "Iwate", "Miyagi", "Akita", "Yamagata", "Fukushima",
		...
		String urlPrefecture = "";
		String urlTypeStudies = "";
		...
		public String getSearchUrl(String[] prefecture){
			if (prefecture.length > 0 && !prefecture[0].equals("all")) { // If many prefectures choosen
				...
				setUrl("http://www.jpss.jp/en/search/?tb=1&a%5Bnm%5D=&a%5Bfw%5D=&u%5Bfc%5D=&u%5Bdp%5D="
						+ getTypeUniUrl() + getAdmisionMonthUrl() + getDeadLineUrl() + getEjuUrl() + getEngExamUrl() + getAdmisionUniUrl() +
				...
				if (getTypeStudiesList().length > 0) { // If many prefectures choosen and many studies choosen
					setUrl("http://www.jpss.jp/en/search/?tb=1&a%5Bnm%5D=&a%5Bfw%5D=&u%5Bfc%5D=&u%5Bdp%5D="
							+ getTypeUniUrl() + getAdmisionMonthUrl() + getDeadLineUrl() + getEjuUrl() + getEngExamUrl() + getAdmisionUniUrl() +
							getUrlTypeStudies() + "&a%5Bpf%5D=" + urlPrefecture + "&search.x=177&search.y=11&search=search");
			...
			if (getPrefecture()[0].equals("all")) { // If no prefecture choosen
				...
				if (typeStudiesList.length > 0) { // If many studies choosen
					setUrl("http://www.jpss.jp/en/search/?tb=1&a%5Bnm%5D=&a%5Bfw%5D=&u%5Bfc%5D=&u%5Bdp%5D="
							+ getTypeUniUrl() + getAdmisionMonthUrl() + getDeadLineUrl() + getEjuUrl() + getEngExamUrl() + getAdmisionUniUrl() +
							getUrlTypeStudies() + "&a%5Bpf%5D=" + getUrlPrefecture() + "&search.x=177&search.y=11&search=search");
		...
		public void setTypeStudiesList(String[] typeStudiesList) {
		...
		public void setUrlTypeStudies(String urlTypeStudies) {
		...
		public void setTypeUniUrl(String typeUniUrl) {
			this.typeUniUrl = typeUniUrl;
		}

		public void setAdmisionMonthUrl(String admisionMonthUrl) {
			this.admisionMonthUrl = admisionMonthUrl;
		}

		public void setDeadLineUrl(String deadLineUrl) {
			this.deadLineUrl = deadLineUrl;
		}

		public void setEjuUrl(String ejuUrl) {
			this.ejuUrl = ejuUrl;
		}

		public void setEngExamUrl(String engExamUrl) {
			this.engExamUrl = engExamUrl;
		}

		public void setAdmisionUniUrl(String admisionUniUrl) {
			this.admisionUniUrl = admisionUniUrl;
		}

		public void setUrlPrefecture(String urlPrefecture) {
