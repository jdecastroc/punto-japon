...
public class UniversityCrawler {
	 ...
	 *            ->Specifies the string you found while parsing
	 */
	public String crawlUniversities(String url, String[] prefectureSearchName, CollegeList universitiesList,
		...
		for (Element element : text) { // Take all the uni divs
			...
			University university = new University(id, japaneseName, name, prefecture, type, collegeType, guideUrl,
		...
		if (next == false) { // no ha encontrado mas universidades en esta
			...
			return jsonUniversitiesList = crawlUniversities(nextPageString, prefectureSearchName, universitiesList,
