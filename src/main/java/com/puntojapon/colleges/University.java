...
/**
 * Provides the university data structure used in the university crawler
 * 
 * @author jdecastroc
...
public class University extends CollegeBasicInfo {
	 ...
	 */
	public University(String id, String japaneseName, String name, String prefecture, String type, String guideUrl,
